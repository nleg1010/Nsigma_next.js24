...
const Hero = () => {
  ...
  return (
    <section
      id="mosaic-hero"
      className="relative min-h-screen pt-20 flex items-center bg-nsigma-dark overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-nsigma-dark via-nsigma-dark/95 to-nsigma-dark"></div>
