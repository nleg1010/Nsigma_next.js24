...
const EngagementCard = ({
  ...
  return (
    <div
      className={`w-full h-full rounded-xl tilted-grid-radient p-4 border-b border-r border-gray-800 hover:scale-[1.02] transition-transform hover:border-[#F6AF23] hover:border`}
    >
